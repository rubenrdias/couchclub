...
class HighlightCVCell: UICollectionViewCell {
    
    static let reuseIdentifier = "HighlightCVCell"
    ...
    private func setupContainers() {
        ...
        NSLayoutConstraint.activate([
            ...
            highlightLeftContainer.leadingAnchor.constraint(equalTo: contentView.leadingAnchor),
            ...
            highlightRightContainer.trailingAnchor.constraint(equalTo: contentView.trailingAnchor),
        ])
    }
